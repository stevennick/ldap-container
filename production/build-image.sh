...
# echo ============= Build image caffe-18.08-py2-v1
...
#echo ============= Build image cuda_9.0-cudnn7.1-devel-ubunt./cuda_9.0-cudnn7.1-devel-ubuntu16.04
#docker build -t registry.twcc.ai/ngc/nvidia/cuda_9.0-cudnn7.1-devel-ubuntu16.04-v1:latest -f ./cuda_9.0-cudnn7.1-devel-ubuntu16.04/Dockerfile common  && \
#docker push registry.twcc.ai/ngc/nvidia/cuda_9.0-cudnn7.1-devel-ubuntu16.04-v1:latest 
